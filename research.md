...
<i class="fa-solid fa-circle-question"></i> *Can we rigorously quantify the uncertainty of AI models, e.g., Large Language Models (LLMs), price predictors, or drones, under distribution shifts and adversarial manipulations?*
